...
class ManagementPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Refetch<Query$GetWalletBalance>? refetchWalletBalance;
    Refetch<Query$GetMyEvents>? refetchMyEvents;

    Future<void> refreshAll() async {
      await Future.wait([
        if (refetchWalletBalance != null) refetchWalletBalance!(),
        if (refetchMyEvents != null) refetchMyEvents!(),
      ]);
    }
